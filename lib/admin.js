...
export const POST_STATUSES = ['draft', 'in_review', 'scheduled', 'published', 'archived'];

// Paginated, sortable, filterable list for the dashboard. Returns the page of
// posts plus the total (filtered) count so the UI can render pagination.
export async function getAdminPosts({
  ...
  if (status && POST_STATUSES.includes(status)) query = query.eq('status', status);
